...
from fg import website
from fg.basics import *
from fg.config import create_config
from fg.database import *
from fg.download_driver import *
from fg.load_files import *
from fg.proxies import *
...
print(bcolors.OKCYAN + """
           [ GitHub : https://github.com/furjac/FG_Teams ]
""" + bcolors.ENDC)
...
if __name__ == '__main__':
    ...
    clean_exe_temp(folder='fg_viewer')
    date_fmt = datetime.now().strftime("%d-%b-%Y %H:%M:%S")
